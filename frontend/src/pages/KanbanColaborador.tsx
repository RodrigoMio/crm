...
import { BoardWithLeadsCount, MoveLeadDto, UpdateKanbanBoardDto } from '../types/kanban-board'
            ...
            return (
              ...
              >
                <div
                  ...
                  style={{ backgroundColor: board.cor_hex, color: board.cor_fonte_hex || '#000000' }}
                  onDoubleClick={() => toggleBoardMinimized(board.id)}
                  title={board.nome}
                >
                  <div className="board-title-row">
                    <div className="board-name" title={board.nome} style={{ color: board.cor_fonte_hex || '#000000' }}>
                      {board.nome}
                    </div>
                    {!isMinimized && (
                                ...
                                <button
                                  ...
                                  onClick={async () => {
                                    try {
                                      ...
                                      const response = await api.get(`/kanban-boards/${board.id}/leads/export?${params.toString()}`, { responseType: 'blob' })
