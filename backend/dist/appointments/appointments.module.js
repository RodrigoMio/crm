...
exports.AppointmentsModule = AppointmentsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([appointment_entity_1.Appointment, lead_entity_1.Lead, occurrence_entity_1.Occurrence]), leads_module_1.LeadsModule],
        controllers: [appointments_controller_1.AppointmentsController, appointments_controller_1.AppointmentsControllerById],
